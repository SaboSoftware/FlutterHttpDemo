...
class MainScreenState  extends State{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("AlışVeriş Sistemi",style: TextStyle(color: Colors.orange),),
  ...
  void getCategoriesFromApi() {
    CategoryApi.getCategorieas().then((response){
      setState(() {
  ...
  Widget getCategoryWidget(Category category) {
    return FlatButton(
      ...
      child: Text(category.categoryName, style: TextStyle(color: Colors.blueAccent),),
